...
select trips_combined.tripid,
    ...
    EXTRACT(YEAR FROM trips_combined.pickup_datetime) as year,
    EXTRACT(MONTH FROM trips_combined.pickup_datetime) as month,
    {{ get_date_quater("trips_combined.pickup_datetime") }} as quater,
